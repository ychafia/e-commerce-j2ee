    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="http://116.124.128.191/11st/Brand_17.jpg" alt="">
                    <div class="caption-full">
                        <h4 class="pull-right"></h2></h4>
                        <h4><bean:write name="unprod" property="libelleProd"/> : <bean:write name="unprod" property="prixVenteProd"/>EURO
                        </h4>
                        <p>
